...
export function NavDropDown4() {
  return (
    <NavigationMenu className="hidden lg:flex ml-8 mr-8 mt-[0.2px] bg-transparent">
      <NavigationMenuList>
        <NavigationMenuItem>
          <NavigationMenuTrigger className="text-sm tracking-wide font-bold space-x-1 text-slate-950">INDUSTRIES</NavigationMenuTrigger>
          <NavigationMenuContent className="border-none">
            <ul className="flex flex-wrap w-[200px] md:w-[200px] gap-1 p-2 md:p-4 bg-white border-[1px] border-gray-200">
