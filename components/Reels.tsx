...
const Reels = () => {
  return (
    <div className="flex w-full justify-center gap-4 mb-20 -mt-24 py-20 text-slate-950">
        <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col">
                <p className="font-semibold text-xl">Hype Sports Media</p>
        ...
        <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col">
                <p className="font-semibold text-xl">Luxe Premium</p>
                <p className="text-sm">RESIDENTIAL / 2025</p>
            </div>
        </div>
        ...
        <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col">
                <p className="font-semibold text-xl">Mach 2 Auto</p>
                <p className="text-sm">RESIDENTIAL / 2025</p>
            </div>
        </div>
