...
import { NavDropDown4 } from './Navdropdown4'
import { NavDropDown3 } from './Navdropdown3'
  ...
  return (
    <div className="flex lg:flex-col w-full justify-between lg:justify-center items-center pt-8 navbar z-50 gap-8 bg-transparent px-4">
      <Link href='/' className={cn(
            "relative dark:text-slate-50 items-center flex space-x-1 text-slate-950  hover:text-[#b2b2b2] w-[150px]"
          )}>
      ...
      {navItems.map((navItem: any, idx: number) => (
        <Link 
          ...
          href={navItem.link}
          className={cn(
            "relative dark:text-slate-50 items-center hidden lg:flex space-x-1 text-slate-950 hover:text-[#b2b2b2]"
          )}
        >
