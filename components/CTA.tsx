...
const CTA = () => {
  return (
    ...
    // </div>
    // 
    <div className="w-[90%] lg:w-[70%] relative overflow-hidden flex flex-col justify-center items-center p-4 rounded-2xl self-center gap-10 h-[500px] mb-20 bg-white border-[1px] border-gray-300">
      <div className="z-30 flex flex-col justify-center items-center gap-6">
        ...
        <div className="flex flex-col lg:flex-row gap-2">
            ...
            <Button className="bg-transparent border-[1px] border-slate-950 h-[55px] w-[220px] text-slate-950 font-semibold text-base">Contact sales</Button>
        </div>
      </div>
    </div>
  )
